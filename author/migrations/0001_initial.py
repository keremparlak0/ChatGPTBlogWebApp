# Generated by Django 4.2 on 2023-06-07 19:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("stemmed_title", models.TextField(blank=True, default="", null=True)),
                ("stemmed_tags", models.TextField(blank=True, default="", null=True)),
                (
                    "search_post",
                    django.contrib.postgres.search.SearchVectorField(null=True),
                ),
                ("tags_full", models.CharField(blank=True, max_length=2550, null=True)),
                (
                    "search_author",
                    django.contrib.postgres.search.SearchVectorField(null=True),
                ),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["search_post", "search_author"],
                name="author_blog_search__f22647_gin",
            ),
        ),
    ]
